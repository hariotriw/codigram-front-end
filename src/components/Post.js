...
const Post = ({strId, image, UserId, caption, createdAt}) => {
    const [imagee, setImagee] = useState("https://via.placeholder.com/150")
	return (
		<div className="container-fluid p-0 mb-4 bg-snow border border-dark">
            ...
            <div className="row p-0 m-0">
                <div className="mx-auto d-flex py-2 mb-2">
                    ...
                    <Link className="no-link  me-auto d-flex my-auto" to={`u/${UserId}`}>
                        <p className="fs-5 text-dark me-auto d-flex my-auto ">{UserId}</p>
                    </Link>
